# Google Play Store Listing — Vane Bunny (English)

Copy text from the sections below into Play Console for the English (US) listing.
...
## Full description (1241/4000 chars)
...
Tapped the wrong number, or thought of something to add? Edit any past
check-in; it keeps the time you actually logged it.
...
anyone. Edit or delete any entry any time; uninstalling removes
everything.
